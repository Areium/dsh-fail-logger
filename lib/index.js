...
const PROMPT_TEXT = "Write scripts to disk before running; no Shell/Python in template strings; derive paths via import.meta.url; confirm edit old_string against read content. On tool failure, load fail-log-guide skill before retrying.";
